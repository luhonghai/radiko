...
public class RecordingHelper {
    ...
    private final long recordedSampleRate;
    ...
    public void copyWaveFile(String inFilename,String outFilename) throws IOException {
        ...
        long totalAudioLen;
        long totalDataLen;
        long longSampleRate = recordedSampleRate;
        int channels = 2;
        long byteRate = RECORDER_BPP * recordedSampleRate * channels / 8;
        ...
        try {
            ...
            SimpleAppLog.info("File size: " + totalDataLen);
